                ...
                <div class="card shadow-sm">
                    ...
                    <h5>Your Blog Posts</h5>
                        ...
                        <div class="button-group d-flex justify-content-between align-items-center mb-4">
                            <form action="<?= site_url('auth/upload'); ?>" method="post" enctype="multipart/form-data" class="me-2">
                                <?= csrf_field(); ?>
                                <div class="form1">
                            ...
                            <a href="<?= site_url('blog/create'); ?>" class="btn btn-custom2 btn-custom-danger">Create Blog</a>
                            </div>
                        </div>
                    </div>
                </div>
